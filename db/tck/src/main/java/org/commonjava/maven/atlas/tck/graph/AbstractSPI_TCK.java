...
import org.commonjava.cartographer.db.RelationshipGraphFactory;
...
public abstract class AbstractSPI_TCK
{
        ...
        throws Exception
    {
        final RelationshipGraph graph =
            graphFactory().open( new ViewParams.Builder( params ).withActiveSources( Collections.singleton( RelationshipConstants.ANY_SOURCE_URI ) )
                                                                 .build(), create );
        return graph;
    }
