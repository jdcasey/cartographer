    ...
    extends AbstractSPI_TCK
{
        ...
        throws Exception
    {
        ...
        final Set<ProjectRelationship<?, ?>> rejected = graph.storeRelationships(
                                         new SimpleDependencyRelationship( source, project, new SimpleArtifactRef( dep, null, null ), null, 0, false, false, false ),
                                         new SimpleDependencyRelationship( source, dep,  new SimpleArtifactRef( dep2,  null, null ), null, 0, false, false, false ),
                                         new SimpleDependencyRelationship( source, dep2,  new SimpleArtifactRef( dep,  null, null ), null, 0, false, false, false ) );
        /* @formatter:on */
