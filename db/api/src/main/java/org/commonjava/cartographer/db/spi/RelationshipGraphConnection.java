...
import org.commonjava.cartographer.db.ViewParams;
    ...
    extends Closeable
{
    ...
    Collection<? extends ProjectRelationship<?, ?>> getRelationshipsDeclaredBy( ViewParams params,
                                                                                ProjectVersionRef root );

    Collection<? extends ProjectRelationship<?, ?>> getRelationshipsTargeting( ViewParams params,
                                                                               ProjectVersionRef root );
